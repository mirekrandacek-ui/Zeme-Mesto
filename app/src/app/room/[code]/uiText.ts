...
export const UI_TEXT = {
  cs: {
    ...
    premiumLockedCategoryOfferIntro: "Při zakoupení kategorie se ti automaticky odemkne možnost volby počtu a pořadí kategorií, se kterými chceš hrát.",
    superPremiumUpsellBefore: "Nebo jen za 60 Kč budeš mít",
    superPremiumLinkText: "Super Premium",
    superPremiumUpsellAfter: "a k dispozici všechny rozšířené kategorie a možnost vytvořit si až 5 vlastních.",
    ...
    waitingPlayerNextRound: "připojí se od dalšího kola",
      ...
      premiumComingSoon: "Nákup Premium připojíme před vydáním aplikace.",
  ...
  en: {
    ...
    premiumLockedCategoryOfferIntro: "Buying this category automatically unlocks category count and category order selection for the categories you want to play with.",
    superPremiumUpsellBefore: "Or for a small extra payment you can get",
    superPremiumLinkText: "Super Premium",
    superPremiumUpsellAfter: "with all extended categories and up to 5 custom categories.",
    ...
    waitingPlayerNextRound: "will join from the next round",
      ...
      premiumComingSoon: "Google Play purchases will be connected before release.",
  ...
  es: {
    ...
    premiumLockedCategoryOfferIntro: "Al comprar esta categoría, se desbloquea automáticamente la opción de elegir el número y el orden de las categorías con las que quieres jugar.",
    superPremiumUpsellBefore: "O por un pequeño extra puedes conseguir",
    superPremiumLinkText: "Super Premium",
    superPremiumUpsellAfter: "con todas las categorías ampliadas y hasta 5 categorías propias.",
    ...
    waitingPlayerNextRound: "se unirá desde la siguiente ronda",
      ...
      premiumComingSoon: "Las compras de Google Play se conectarán antes del lanzamiento.",
