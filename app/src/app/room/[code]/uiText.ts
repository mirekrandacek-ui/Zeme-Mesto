...
export const UI_TEXT = {
  cs: {
    ...
    premiumLockedCategoryOffer: "Při zakoupení kategorie se ti automaticky odemkne možnost volby počtu a pořadí kategorií, se kterými chceš hrát. Nebo si připlať už jen 60 Kč a budeš mít k dispozici všechny rozšířené kategorie a možnost vytvořit si až 5 vlastních.",
  ...
  en: {
    ...
    premiumLockedCategoryOffer: "Buying this category automatically unlocks category count and category order selection for the categories you want to play with. Or pay a little extra for Super Premium and get all extended categories plus up to 5 custom categories.",
  ...
  es: {
    ...
    premiumLockedCategoryOffer: "Al comprar esta categoría, se desbloquea automáticamente la opción de elegir el número y el orden de las categorías con las que quieres jugar. O paga un poco más por Super Premium y tendrás todas las categorías ampliadas y hasta 5 categorías propias.",
