...
export const UI_TEXT = {
  cs: {
    ...
    superPremiumUpsellAfter: "a získáš neomezený počet hráčů, základní kategorie a 4 rozšířené kategorie Film / Seriál, Sport, Značka a Auto / Moto.",
  ...
  en: {
    ...
    superPremiumUpsellAfter: "and get unlimited players, all basic categories and 4 extended categories: Film / Series, Sport, Brand and Car / Motorbike.",
  ...
  es: {
    ...
    superPremiumUpsellAfter: "y obtén jugadores ilimitados, todas las categorías básicas y 4 categorías ampliadas: Película / Serie, Deporte, Marca y Coche / Moto.",
  ...
  de: {
    ...
    superPremiumUpsellAfter: "und erhalte unbegrenzt viele Spieler, alle Grundkategorien und 4 erweiterte Kategorien: Film / Serie, Sportart, Marke und Auto / Motorrad.",
  ...
  "pt-BR": {
    ...
    superPremiumUpsellAfter: "e tenha jogadores ilimitados, todas as categorias básicas e 4 categorias adicionais: Filme / Série, Esporte, Marca e Carro / Moto.",
  ...
  id: {
    ...
    superPremiumUpsellAfter: "dan dapatkan pemain tanpa batas, semua kategori dasar, serta 4 kategori tambahan: Film / Serial, Olahraga, Merek, dan Mobil / Motor.",
  ...
  tr: {
    ...
    superPremiumUpsellAfter: "ve sınırsız oyuncu, tüm temel kategoriler ve 4 ek kategori elde et: Film / Dizi, Spor, Marka ve Araba / Motosiklet.",
  ...
  pl: {
    ...
    superPremiumUpsellAfter: "i zyskaj nieograniczoną liczbę graczy, wszystkie kategorie podstawowe oraz 4 kategorie rozszerzone: Film / Serial, Sport, Marka i Samochód / Motocykl.",
  ...
  it: {
    ...
    superPremiumUpsellAfter: "e ottieni giocatori illimitati, tutte le categorie base e 4 categorie estese: Film / Serie TV, Sport, Marca e Auto / Moto.",
