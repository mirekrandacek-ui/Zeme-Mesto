...
export const UI_TEXT = {
  cs: {
    ...
    superPremiumUpsellAfter: "a získáš neomezený počet hráčů, volitelné základní kategorie a 4 rozšířené kategorie Film / Seriál, Sport, Značka a Auto / Moto.",
    ...
    waitingPlayerNextRound: "připojí se od dalšího kola",
      ...
      freeRewardButtonLine1: "Sledovat reklamu",
      freeRewardButtonLine2: "a odemknout další 3 kola",
  ...
  en: {
    ...
    superPremiumUpsellAfter: "and get unlimited players, optional basic categories and 4 extended categories: Film / Series, Sport, Brand and Car / Motorbike.",
    ...
    waitingPlayerNextRound: "will join from the next round",
      ...
      freeRewardButtonLine1: "Watch an ad",
      freeRewardButtonLine2: "and unlock 3 more rounds",
  ...
  es: {
    ...
    superPremiumUpsellAfter: "y obtén jugadores ilimitados, categorías básicas opcionales y 4 categorías ampliadas: Película / Serie, Deporte, Marca y Coche / Moto.",
    ...
    waitingPlayerNextRound: "se unirá desde la siguiente ronda",
      ...
      freeRewardButtonLine1: "Ver un anuncio",
      freeRewardButtonLine2: "y desbloquear 3 rondas más",
  ...
  de: {
    ...
    superPremiumUpsellAfter: "und erhalte unbegrenzt viele Spieler, frei wählbare Grundkategorien und 4 erweiterte Kategorien: Film / Serie, Sportart, Marke und Auto / Motorrad.",
    ...
    freeRewardButtonLine1: "Werbung ansehen",
    freeRewardButtonLine2: "und 3 weitere Runden freischalten",
  ...
  fr: {
    ...
    timeLimit: "Limite de temps par manche",
    ...
    superPremiumUpsellAfter: "et profite d’un nombre de joueurs illimité, de toutes les catégories de base et de 4 catégories supplémentaires : Film / Série, Sport, Marque et Voiture / Moto.",
    ...
    freeRewardButtonLine1: "Regarder une publicité",
    freeRewardButtonLine2: "et débloquer 3 manches supplémentaires",
  ...
  "pt-BR": {
    ...
    timeLimit: "Limite de tempo da rodada",
    ...
    superPremiumUpsellAfter: "e tenha jogadores ilimitados, categorias básicas opcionais e 4 categorias adicionais: Filme / Série, Esporte, Marca e Carro / Moto.",
    ...
    freeRewardButtonLine1: "Assistir a um anúncio",
    freeRewardButtonLine2: "e liberar mais 3 rodadas",
  ...
  id: {
    ...
    superPremiumUpsellAfter: "dan dapatkan pemain tanpa batas, kategori dasar yang dapat dipilih, serta 4 kategori tambahan: Film / Serial, Olahraga, Merek, dan Mobil / Motor.",
    ...
    freeRewardButtonLine1: "Tonton iklan",
    freeRewardButtonLine2: "dan buka 3 ronde lagi",
  ...
  tr: {
    ...
    superPremiumUpsellAfter: "ve sınırsız oyuncu, seçilebilir temel kategoriler ve 4 ek kategori elde et: Film / Dizi, Spor, Marka ve Araba / Motosiklet.",
    ...
    freeRewardButtonLine1: "Reklam izle",
    freeRewardButtonLine2: "ve 3 tur daha aç",
  ...
  pl: {
    ...
    freeRewardButtonLine1: "Obejrzyj reklamę",
    freeRewardButtonLine2: "i odblokuj 3 kolejne rundy",
  ...
  it: {
    ...
    timeLimit: "Limite di tempo del turno",
    ...
    superPremiumUpsellAfter: "e ottieni giocatori illimitati, categorie base selezionabili e 4 categorie estese: Film / Serie TV, Sport, Marca e Auto / Moto.",
    ...
    freeRewardButtonLine1: "Guarda un annuncio",
    freeRewardButtonLine2: "e sblocca altri 3 turni",
