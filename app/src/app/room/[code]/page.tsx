        ...
        <section className={roomStyles.scoringScreen}>
          ...
          {!everyoneScored && (
            ...
            {everyoneScored && (
              shouldShowFreeLimitUpsell ? (
                ...
                >
                  ...
                  <p style={{ margin: "8px 2px 0", fontSize: 14, lineHeight: 1.35 }}>
                    {uiMessage({
            ...
            it: "Giocatori illimitati, categorie base selezionabili e 4 categorie estese: Film / Serie TV, Sport, Marca e Auto / Moto.",
                  ...
                  <p style={{ margin: "8px 2px 4px", fontSize: 14, lineHeight: 1.35 }}>
          {t("superPremiumBenefitsIntro")}
        </p>
        <ul style={{ margin: "0 2px 8px 20px", padding: 0, fontSize: 14, lineHeight: 1.35 }}>
          {t("superPremiumBenefits").split("|").map((benefit) => (
            <li key={benefit}>{benefit}</li>
          ))}
        </ul>
