...
const HOME_TEXT = {
  cs: {
    ...
    superPremiumCategories:
      "Rozšířené kategorie v ceně: Film / Seriál, Sport, Značka, Auto / Moto.",
    creating: "Vytvářím…",
  ...
  en: {
    ...
    superPremiumCategories:
      "Extended categories included: Film / Series, Sport, Brand, Car / Motorbike.",
    creating: "Creating…",
  ...
  es: {
    ...
    superPremiumCategories:
      "Categorías ampliadas incluidas: Película / Serie, Deporte, Marca, Coche / Moto.",
    creating: "Creando…",
  ...
  de: {
    ...
    superPremiumCategories:
      "Enthaltene erweiterte Kategorien: Film / Serie, Sportart, Marke, Auto / Motorrad.",
  ...
  fr: {
    ...
    superPremiumDescription: "Nombre de joueurs illimité. Inclus : Film / Série, Sport, Marque et Voiture / Moto. Débloque progressivement d’autres catégories et options de jeu avec des pièces gagnées en jouant régulièrement.",
    superPremiumCategories: "Catégories supplémentaires incluses : Film / Série, Sport, Marque, Voiture / Moto.",
    creating: "Création…",
    ...
    superPremiumPurchaseDescription: "Nombre de joueurs illimité. Inclus : Film / Série, Sport, Marque et Voiture / Moto. Débloque progressivement d’autres catégories et options de jeu avec des pièces gagnées en jouant régulièrement.",
  ...
  "pt-BR": {
    ...
    superPremiumDescription: "Jogadores ilimitados. Inclui: Filme / Série, Esporte, Marca e Carro / Moto. Libere gradualmente mais categorias e opções de jogo com moedas ganhas ao jogar regularmente.",
    superPremiumCategories: "Categorias adicionais incluídas: Filme / Série, Esporte, Marca, Carro / Moto.",
    creating: "Criando…",
    ...
    buyPremium: "Comprar Premium",
    superPremiumPurchaseDescription: "Jogadores ilimitados. Inclui: Filme / Série, Esporte, Marca e Carro / Moto. Libere gradualmente mais categorias e opções de jogo com moedas ganhas ao jogar regularmente.",
  ...
  id: {
    ...
    superPremiumDescription: "Pemain tanpa batas. Termasuk: Film / Serial, Olahraga, Merek, dan Mobil / Motor. Buka kategori dan opsi permainan lain secara bertahap dengan koin yang diperoleh dari bermain secara rutin.",
    superPremiumCategories: "Kategori tambahan yang termasuk: Film / Serial, Olahraga, Merek, Mobil / Motor.",
    creating: "Membuat…",
    ...
    superPremiumPurchaseDescription: "Pemain tanpa batas. Termasuk: Film / Serial, Olahraga, Merek, dan Mobil / Motor. Buka kategori dan opsi permainan lain secara bertahap dengan koin yang diperoleh dari bermain secara rutin.",
  ...
  tr: {
    ...
    superPremiumDescription: "Sınırsız oyuncu. Dahil: Film / Dizi, Spor, Marka ve Araba / Motosiklet. Düzenli oynayarak kazandığın coinlerle diğer kategorileri ve oyun seçeneklerini zamanla aç.",
    superPremiumCategories: "Dahil olan ek kategoriler: Film / Dizi, Spor, Marka, Araba / Motosiklet.",
    ...
    superPremiumPurchaseDescription: "Sınırsız oyuncu. Dahil: Film / Dizi, Spor, Marka ve Araba / Motosiklet. Düzenli oynayarak kazandığın coinlerle diğer kategorileri ve oyun seçeneklerini zamanla aç.",
  ...
  pl: {
    ...
    superPremiumDescription: "Nieograniczona liczba graczy. W cenie: Film / Serial, Sport, Marka i Samochód / Motocykl. Kolejne kategorie i opcje gry odblokowujesz stopniowo za monety zdobywane dzięki regularnej grze.",
    superPremiumCategories: "Rozszerzone kategorie w cenie: Film / Serial, Sport, Marka, Samochód / Motocykl.",
    creating: "Tworzenie…",
    ...
    superPremiumPurchaseDescription: "Nieograniczona liczba graczy. W cenie: Film / Serial, Sport, Marka i Samochód / Motocykl. Kolejne kategorie i opcje gry odblokowujesz stopniowo za monety zdobywane dzięki regularnej grze.",
  ...
  it: {
    ...
    superPremiumDescription: "Giocatori illimitati. Inclusi: Film / Serie TV, Sport, Marca e Auto / Moto. Sblocca gradualmente altre categorie e opzioni di gioco con le monete ottenute giocando regolarmente.",
    superPremiumCategories: "Categorie estese incluse: Film / Serie TV, Sport, Marca, Auto / Moto.",
    creating: "Creazione…",
    ...
    superPremiumPurchaseDescription: "Giocatori illimitati. Inclusi: Film / Serie TV, Sport, Marca e Auto / Moto. Sblocca gradualmente altre categorie e opzioni di gioco con le monete ottenute giocando regolarmente.",
